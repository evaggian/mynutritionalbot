...
class VoiceResponse(TwiML):
    ...
    def prompt(
        self, for_=None, error_type=None, card_type=None, attempt=None, **kwargs
    ):
        """
...
class Say(TwiML):
    ...
    def ssml_prosody(self, words=None, volume=None, rate=None, pitch=None, **kwargs):
        """
        Create a <Prosody> element
        ...
        """
        return self.prosody(
            words=words, volume=volume, rate=rate, pitch=pitch, **kwargs
        )
    ...
    def say_as(self, words, interpret_as=None, role=None, **kwargs):
        ...
        """
        return self.nest(
            SsmlSayAs(words, interpret_as=interpret_as, role=role, **kwargs)
        )
