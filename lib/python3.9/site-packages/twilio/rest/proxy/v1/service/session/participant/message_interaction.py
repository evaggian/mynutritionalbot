...
class MessageInteractionList(ListResource):
    ...
    def create(self, body=values.unset, media_url=values.unset):
        ...
        :param list[unicode] media_url: Reserved
        ...
        """
        data = values.of(
            {"Body": body, "MediaUrl": serialize.map(media_url, lambda e: e),}
        )
...
class MessageInteractionInstance(InstanceResource):
    ...
    def __init__(
        self, version, payload, service_sid, session_sid, participant_sid, sid=None
    ):
        """
