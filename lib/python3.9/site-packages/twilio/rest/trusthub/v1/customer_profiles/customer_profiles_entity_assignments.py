...
class CustomerProfilesEntityAssignmentsContext(InstanceContext):
    def __init__(self, version, customer_profile_sid, sid):
        ...
        self._uri = "/CustomerProfiles/{customer_profile_sid}/EntityAssignments/{sid}".format(
            **self._solution
        )
    ...
    def __repr__(self):
        ...
        return "<Twilio.Trusthub.V1.CustomerProfilesEntityAssignmentsContext {}>".format(
            context
        )
...
class CustomerProfilesEntityAssignmentsInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        """
        context = " ".join("{}={}".format(k, v) for k, v in self._solution.items())
        return "<Twilio.Trusthub.V1.CustomerProfilesEntityAssignmentsInstance {}>".format(
            context
        )
