...
class UserChannelPage(Page):
    def __init__(self, version, response, solution):
        ...
        :returns: twilio.rest.ip_messaging.v2.service.user.user_channel.UserChannelPage
        :rtype: twilio.rest.ip_messaging.v2.service.user.user_channel.UserChannelPage
        """
...
class UserChannelContext(InstanceContext):
    def __init__(self, version, service_sid, user_sid, channel_sid):
        ...
        self._uri = "/Services/{service_sid}/Users/{user_sid}/Channels/{channel_sid}".format(
            **self._solution
        )
