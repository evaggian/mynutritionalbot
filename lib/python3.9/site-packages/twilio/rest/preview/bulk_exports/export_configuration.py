...
class ExportConfigurationContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        return "<Twilio.Preview.BulkExports.ExportConfigurationContext {}>".format(
            context
        )
...
class ExportConfigurationInstance(InstanceResource):
    ...
    def _proxy(self):
        ...
        if self._context is None:
            self._context = ExportConfigurationContext(
                self._version, resource_type=self._solution["resource_type"],
            )
    ...
    def __repr__(self):
        ...
        """
        context = " ".join("{}={}".format(k, v) for k, v in self._solution.items())
        return "<Twilio.Preview.BulkExports.ExportConfigurationInstance {}>".format(
            context
        )
