...
class MobileList(ListResource):
    ...
    def create(
        ...
        :param MobileInstance.EmergencyStatus emergency_status: Displays if emergency calling is enabled for this number.
...
class MobileInstance(InstanceResource):
    ...
    def emergency_address_status(self):
        ...
        :rtype: MobileInstance.EmergencyAddressStatus
        """
